...
data['src[arp]'] = data['src[arp]'].astype(str)
data['dst[arp]'] = data['dst[arp]'].astype(str)
data['port_no'] = data['port_no'].astype(str)
data['Protocol'] = data['Protocol'].astype(str)
data['src[eth]'] = data['src[eth]'].astype(str) 
data['dst[eth]'] = data['dst[eth]'].astype(str)
data['opcode'] = data['opcode'].astype(str) 
data['inport'] = data['inport'].astype(str) 
data['outport'] = data['outport'].astype(str) 

ordered_data = pd.get_dummies(data,
                              columns = ['switch','src[arp]','dst[arp]','src[eth]','dst[eth]''Protocol','port_no',inport,outport,opcode])
#ordered_data.head()
